...
require_once('../models/select/select-Promotion.php'); //Appel du script de selection
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <form action="<?= $url ?>" class="shadow p-3" method="POST">
                            ...
                            <div class="row">
                                <div class="col-12 p-3">
                                    <label for="">Decription de la promotion <span class="text-danger">*</span></label>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6 p-3">
                                    <label for="">Année scolaire <span class="text-danger">*</span></label>
                                    <select required name="annee" id="" class="form-select">
                                        <?php
                                        $rep = $connexion->prepare("SELECT * from `anneescolaire` WHERE statut=?");
                                        $rep->execute([0]);
                                        $Annee = "";
                                        while ($Option = $rep->fetch()) {
                                            ...
                                            ?>
                                                <option <?php if ($Option['id'] == $Annee) { ?> Selected <?php } ?> value="<?php echo $Option['id']; ?>">
                                                    <?php echo  $Option['Description']; ?>
                                                </option>
                                            <?php } else {
                                            ?>
                                                <option value="<?php echo $Option['id']; ?>">
                                                    <?php echo  $Option['libelle']; ?>
                                                </option>
                                        <?php }
                                        }
                                        ?>
