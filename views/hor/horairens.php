...
<nav class="navbar navbar-expand-lg navbar-light bg-light rounded" aria-label="Twelfth navbar example">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample10">
          ...
          <li class="nav-item">
            <a class="nav-link active " aria-current="page" href="horaire.php">tout l'horaire</a>
          </li>
            ...
            <li class="nav-item dropdown">
              ...
              <?php 
                    ...
                    ?>
                        ...
                        <li value=<?php $id=$tab['id']?> ><a  class="anavbar"class="dropdown-item" href="horairensparclasse.php?idcla=<?php echo $tab['id']?> "><?php echo $tab['nomclasse']." ".$tab['options'] ; ?></a>
    ...
    <?php
      $affichclass= $bdd->query("SELECT * FROM `classe`");
      $numero=0;
 ...
 <?php
    ...
    <?php 
                  ...
                  while($jour=$affichercour->fetch())
                   {
                    ...
                    $jours=$jour['id'];
                      ?>
                        ...
                        <?php  
                     $afficherjour= $bdd->query("SELECT heure.unite,horaire.id, cours.nomcours,enseignants.nom,enseignants.postnom FROM affectation,cours,enseignants,horaire,heure WHERE affectation.id=horaire.affectation and affectation.cours=cours.id and affectation.enseignant=enseignants.id and horaire.heure=heure.id and classe='$idcl' and jours='$jours' order by horaire.heure");
                     $numero=0;
     ...
     <?php
                        ...
                        { ?>
                          <td><?php echo  "<strong>".$tab['nomcours']."</strong><br>"   ; ?><a href="demander.php?idhor=<?php echo $tab['id'] ?>"class="btn btn-primary " >Demander</a></td>
                      <?php } 
                      else
                      { ?>
