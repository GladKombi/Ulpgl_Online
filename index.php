...
<body>
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        ...
        <h1 class="text-primary">Ulpgl_OnLine</h1>
      </a>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <img src="photo/bg.jpg" alt="" data-aos="fade-in">

      <div class="container">
        <h2 data-aos="fade-up" data-aos-delay="100" class="">ULPGL<br>On line</h2>
        <p data-aos="fade-up" data-aos-delay="200">Universit, primary and secondary school</p>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <img src="assetts/img/trainers/trainer-1.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <img src="assetts/img/trainers/trainer-2.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Sarah Jhinson</h4>
                <span>Marketing</span>
                <p>
          ...
          <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <img src="assetts/img/trainers/trainer-3.jpg" class="img-fluid" alt="">
              <div class="member-content">
